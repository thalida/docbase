...
<template>
  <div>
        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div
                class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-2 dark:bg-gray-900 dark:ring-1 dark:ring-white/10"
              >
                        ...
                        <li v-for="team in teams" :key="team.name">
                          ...
                          >
                            <span
                              :class="[
                                team.current
                                  ? 'border-indigo-600 text-indigo-600 dark:border-gray-700 dark:text-gray-400'
                                  : 'border-gray-200 text-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600 dark:border-gray-700 dark:text-gray-400 dark:group-hover:border-gray-700 dark:group-hover:text-gray-400',
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
      <!-- Sidebar component, swap this element with another sidebar if you like -->
      <div
        class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 dark:bg-gray-900 dark:border-0"
      >
        <div class="flex h-16 shrink-0 items-center">
          <img
            class="h-8 w-auto"
                  ...
                  >
                    <component
                      ...
                      :class="[
                        item.current
                          ? 'text-indigo-600 dark:text-white'
                          : 'text-gray-400 group-hover:text-indigo-600 dark:text-gray-400 dark:group-hover:text-gray-400',
                        'h-6 w-6 shrink-0'
                      ]"
                      aria-hidden="true"
                    />
