...
<template>
  <Menu as="div" class="relative inline-block text-left">
    ...
    >
      <MenuItems
        class="absolute top-5 right-1 z-10 mt-2 min-w-32 origin-top-right overflow-hidden rounded-md bg-blue-50 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-slate-800"
      >
        <div>
            ...
            <button
              ...
              :class="{
                'bg-teal-100 text-blue-500 dark:bg-slate-900/50 dark:text-blue-500':
                  uiStore.theme === option.key,
                'text-blue-500': uiStore.theme !== option.key && hover,
                'text-gray-700 dark:text-white': uiStore.theme !== option.key && !hover
              }"
            >
